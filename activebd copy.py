...
def defImpDevis (self, idIntervention, idDossier, idDevis):
            ...
            for i in tabla: #cada fila es converteix en un objecte de lista           
                ...
                if unitaire1a==0:
                    ...
                    total1 = "%.2f" %total1a
                    #total1 = round(total1a, 2)
                    unitaire1="%.2f" %unitaire1a
                    quantite1="%.2f" %quantite1a
                ...
                if unitaire2a==0:
                    ...
                    total2 = "%.2f" %total2a 
                    unitaire2="%.2f" %unitaire2a
                    quantite2="%.2f" %quantite2a
                ...
                if unitaire3a==0:
                    ...
                    total3 = "%.2f" %total3a
                    unitaire3="%.2f" %unitaire3a
                    quantite3="%.2f" %quantite3a
                ...
                if unitaire4a==0:
                    ...
                    try:
                        ...
                        total4 = "%.2f" %total4a
                        unitaire4="%.2f" %unitaire4a
                        quantite4="%.2f" %quantite4a
                    except:
                        total4=""
                        unitaire4=""
                        quantite4=""
                ...
                if unitaire5a==0:
                    ...
                    try:
                        ...
                        total5 = "%.2f" %total5a
                        unitaire5="%.2f" %unitaire5a
                        quantite5="%.2f" %quantite5a
                    except:
                        total5=""
                        unitaire5=""
                        quantite5=""
                ...
                if unitaireMOa==0:
                    ...
                    totalMO = "%.2f" %totalMOa
                    unitaireMO="%.2f" %unitaireMOa
                    quantiteMO="%.2f" %quantiteMOa
                ...
                if unitaireMOAa==0:
                    ...
                    try:
                        ...
                        totalMOA = "%.2f" %totalMOAa
                        unitaireMOA="%.2f" %unitaireMOAa
                        quantiteMOA="%.2f" %quantiteMOAa
                    except:
                        totalMOA=""
                        unitaireMOA=""
                        quantiteMOA=""
                ...
                if unitaireDepa==0:
                    ...
                    totalDep = "%.2f" %totalDepa
                    unitaireDep="%.2f" %unitaireDepa
                    quantiteDep="%.2f" %quantiteDepa
                    
                totalTravail = total1a+total2a+total3a+total4a+total5a+totalMOa+totalMOAa+totalDepa
                if totalTravail==0:
                    totalTravaila=""
                else:
                    totalTravaila="%.2f" %totalTravail
